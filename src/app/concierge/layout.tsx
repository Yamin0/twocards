  ...
  return (
    <div className="tc-shell min-h-screen lg:h-screen relative lg:overflow-hidden bg-[#141210]">
      ...
      <div className="relative z-10 p-4 lg:p-6 grid grid-cols-12 gap-4 lg:gap-6 lg:h-screen">
        {/* Mobile top bar */}
        <div className="tc-app-topbar col-span-12 lg:hidden flex items-center justify-between backdrop-blur-xl bg-white/10 border border-white/15 rounded-2xl px-4 py-3">
          <button
          ...
          <Link href="/concierge" className="tc-app-hide flex items-center gap-2">
