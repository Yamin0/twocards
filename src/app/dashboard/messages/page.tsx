...
const conversations = [
  {
    ...
    messages: [
      ...
      { id: 2, sender: "me", text: "Salut Julien ! Bien sur, tu veux la table VIP habituelle ?", time: "13:52", date: "Aujourd'hui" },
      { id: 3, sender: "them", text: "Oui exactement, ils veulent la grande table pres de la piste.", time: "14:10", date: "Aujourd'hui" },
      { id: 4, sender: "me", text: "Parfait, c'est note. Consommation minimum de 2000EUR pour le groupe, ca marche ?", time: "14:15", date: "Aujourd'hui" },
  ...
  },
  {
    ...
    unread: true,
    messages: [
      { id: 1, sender: "me", text: "Sophie, ta reservation pour vendredi est validee. Table 12.", time: "11:30", date: "Aujourd'hui" },
