  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] p-8">
      <div className="backdrop-blur-2xl bg-black/45 border border-white/[0.12] rounded-3xl p-10 max-w-md w-full text-center">
        ...
        <h2 className="text-xl font-bold text-white font-ui mb-2">
        ...
        <div className="flex flex-col items-center gap-3">
          <button
            onClick={reset}
            className="inline-flex items-center gap-2 px-6 py-3 bg-blue-500 hover:bg-blue-400 text-white rounded-xl text-sm font-medium transition-all shadow-[0_0_20px_rgba(96,165,250,0.2)] hover:shadow-[0_0_30px_rgba(96,165,250,0.3)] font-ui"
          >
          ...
          <a
            href="/hotel"
            className="inline-flex items-center gap-2 text-sm text-white/30 hover:text-white/60 font-medium transition-colors font-ui"
          >
